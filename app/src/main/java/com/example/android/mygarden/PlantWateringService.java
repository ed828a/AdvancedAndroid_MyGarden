...
public class PlantWateringService extends IntentService {
    ...
    /**
     * Starts this service to perform Watering a Plant action with the given parameters. If
     * the service is already performing a task this action will be queued.
     * EXTRA_PLANT_ID to pass the plant ID to the service
     * @see IntentService
     */
    public static void startActionWaterPlant(Context context, long plantId) {
        Intent intent = new Intent(context, PlantWateringService.class);
        intent.setAction(ACTION_WATER_PLANT);
        // use EXTRA_PLANT_ID to pass the plant ID to the service
